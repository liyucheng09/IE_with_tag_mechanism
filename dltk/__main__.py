...
"""DLTK command line interface."""
import sys
import dltk
from argparse import ArgumentParser

parser = ArgumentParser(usage="%s -m dltk [options] filename" % sys.executable,
                        description="DLTK command line interface.",
...
if args.user_dict:
    dltk.load_userdict(args.user_dict)
