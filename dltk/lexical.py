...
from dltk.predictor import Predictor
...
class LexicalAnalyzer(object):
    def __init__(self):
        ...
        self.pos_model = None
        self.ner_model = None
        #self.data_path = os.path.join(sys.prefix, "dltk")
        self.data_path = os.path.join(os.getcwd(), "data")
        self.map_file_path = os.path.join(self.data_path, "map.zip")
        #for user segment
        # self.map_file_path = "./train/datasets/demo/maps.pkl"
    ...
    def _load_model(self, model_namel, word_map_name, tag_name):
        ...
        #for user segment
        # char_to_id, id_to_seg = model.load_map(self.map_file_path)
        return Predictor(seg_model_path, char_to_id, id_to_seg)

    def _load_seg_model(self):
        self.seg_model = self._load_model("seg.pb", "char_map", "seg_map")
        #for user segment
        # self.seg_model = self._load_model("myseg.pb", "char_map", "seg_map")
